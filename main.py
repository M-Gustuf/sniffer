...
class Ui_SnifferGUI(QtWidgets.QMainWindow):
    ...
    def setupUi(self, SnifferGUI):
        ...
        SnifferGUI.resize(1150, 850)
        self.centralwidget = QtWidgets.QWidget(SnifferGUI)
        self.centralwidget.setObjectName("centralwidget")
        self.comboBox = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox.setGeometry(QtCore.QRect(90, 20, 251, 21))
        ...
        self.pushButton_TCPstream.setGeometry(QtCore.QRect(770, 20, 81, 23))
        self.pushButton_TCPstream.setObjectName("pushButton_TCPstream")
        self.commandLinkButton = QtWidgets.QCommandLinkButton(self.centralwidget)
        self.commandLinkButton.setGeometry(QtCore.QRect(540, 50, 90, 41))
        self.commandLinkButton.setObjectName("commandLinkButton")
        self.treeWidget = QtWidgets.QTreeWidget(self.centralwidget)
        self.treeWidget.setGeometry(QtCore.QRect(30, 100, 1001, 350))
        ...
        self.tabWidget_Reassemble.setGeometry(QtCore.QRect(440, 470, 673, 330))
        ...
        self.textBrowser_String.setGeometry(QtCore.QRect(0, 0, 667, 330))
        font = QtGui.QFont()
        ...
        self.textBrowser_HEX.setGeometry(QtCore.QRect(0, 0, 667, 330))
        ...
        self.textBrowser_GBK.setGeometry(QtCore.QRect(0, 0, 667, 330))
        ...
        self.textBrowser_ANSI.setGeometry(QtCore.QRect(0, 0, 667, 330))
        ...
        self.textBrowser_UTF8.setGeometry(QtCore.QRect(0, 0, 667, 330))
        ...
        self.textBrowser_PRT.setGeometry(QtCore.QRect(0, 0, 667, 330))
    ...
    def retranslateUi(self, SnifferGUI):
        _translate = QtCore.QCoreApplication.translate
        SnifferGUI.setWindowTitle(_translate("SnifferGUI", "Sniffer"))
        self.comboBox.setItemText(0, _translate("SnifferGUI", "请选择网卡"))
        self.AddIface()
        self.label.setText(_translate("SnifferGUI", "<html><head/><body><p>网卡列表</p></body></html>"))
        self.label_2.setText(_translate("SnifferGUI", "<html><head/><body><p>包过滤选项</p></body></html>"))
        ...
        self.pushButton_reassemble.setText(_translate("SnifferGUI", "数据流重组"))
        ...
        self.actionpass.setText(_translate("SnifferGUI", "测试"))
        self.actionpass_2.setText(_translate("SnifferGUI", "清空"))
    ...
    def ShowDetails(self):
        ...
        if pktlis[pktindex][2] == 'ARP' :
            ...
            self.tabWidget_Details.setTabText(self.tabWidget_Details.indexOf(
                self.tab_IP), _translate("SnifferGUI", "ARP"))
            ...
            self.listWidget_IP.addItem(QtWidgets.QListWidgetItem())
            self.listWidget_IP.item(8).setText(
                _translate("SnifferGUI", "接受者IP地址: " + pktlis[pktindex][11]))
            self.listWidget_IP.addItem(QtWidgets.QListWidgetItem())
            if pktlis[pktindex][7] == "ARP请求":
                self.listWidget_IP.item(9).setText(
                    _translate("SnifferGUI", "信息:谁是 " + pktlis[pktindex][11] + "?请告诉" + pktlis[pktindex][9]))
            ...
            self.tabWidget_Details.setTabText(self.tabWidget_Details.indexOf(
                self.tab_Protocol), _translate("SnifferGUI", "NULL"))
            self.tabWidget_Details.setTabText(self.tabWidget_Details.indexOf(
                self.tab_IP), _translate("SnifferGUI", "RARP"))
            self.listWidget_IP.addItem(QtWidgets.QListWidgetItem())
            self.listWidget_IP.item(0).setText(_translate(
                "SnifferGUI", "硬件类型: " + pktlis[pktindex][3]))
            self.listWidget_IP.addItem(QtWidgets.QListWidgetItem())
            ...
            if pktlis[pktindex][7] == "RARP请求":
                ...
                self.listWidget_IP.item(9).setText(
                    _translate("SnifferGUI", "信息:" + pktlis[pktindex][10] + "你好！你的IP地址是" + pktlis[pktindex][11]))
            ...
            if pktlis[pktindex][12] == 'TCP':
                ...
                if (pktlis[pktindex][18] == 23 or pktlis[pktindex][17] == 23):
                    self.textBrowser_HEX.setText("TELNET，点击上方数据流重组可以展示完整数据流")
                elif (pktlis[pktindex][18] == 21 or pktlis[pktindex][17] == 21):
                    self.textBrowser_HEX.setText("FTP，点击上方数据流重组可以展示完整数据流")
                elif (pktlis[pktindex][18] == 80 or pktlis[pktindex][17] == 80):
                    self.textBrowser_HEX.setText("HTTP，点击上方数据流重组可以展示完整数据流")
                elif (pktlis[pktindex][17] == 443):
                    self.textBrowser_HEX.setText("TLS，安全套接字SSL加密传输，不建议重组！")
                else:
                    self.textBrowser_HEX.setText("不属于TELNET、FTP控制、HTTP的TCP数据流，点击上方数据流重组可以展示完整数据流")
                #FTP
                #HTTP
    ...
    def displaygui(self,showlist, rank):
        ...
        item_num = 0
        # 根据协议分颜色
        if showlist[3] == ['TCP', 'FTP']:
            brush = QtGui.QBrush(QtGui.QColor(231, 230, 255))
            brush.setStyle(QtCore.Qt.SolidPattern)
        elif showlist[3] == ['UDP', 'OICQ']:
            brush = QtGui.QBrush(QtGui.QColor(218, 238, 255))
            brush.setStyle(QtCore.Qt.SolidPattern)
        elif showlist[3] in ['ARP', 'RARP']:
            brush = QtGui.QBrush(QtGui.QColor(250, 240, 215))
            brush.setStyle(QtCore.Qt.SolidPattern)
        elif showlist[3] in 'IPv6':
            brush = QtGui.QBrush(QtGui.QColor(251, 128, 114))
            brush.setStyle(QtCore.Qt.SolidPattern)
        elif showlist[3] == ['ICMP', 'ICMPv6', 'IGMP']:
            brush = QtGui.QBrush(QtGui.QColor(252, 224, 255))
            brush.setStyle(QtCore.Qt.SolidPattern)
        elif showlist[3] == 'HTTP':
            brush = QtGui.QBrush(QtGui.QColor(228, 255, 199))
            brush.setStyle(QtCore.Qt.SolidPattern)
        else:
            brush = QtGui.QBrush(QtGui.QColor(254, 255, 208))
            brush.setStyle(QtCore.Qt.SolidPattern)
    ...
    def list_to_display(self, lista, Num):  # 显示上面窗口的src，dst，prt，len等
        ...
        if lista[2] in ['ARP', 'RARP']:
            ...
            if lista[7] == "RARP请求":
                ...
                listdisplay.append("" + lista[10] + "你好！你的IP地址是" + lista[11])
            elif lista[7] == "ARP请求 (0001)":
                listdisplay.append("谁是" + lista[11] + "？请告诉" + lista[9])
            elif lista[7] == "ARP回显 (0002)":
